...
static Array const s_title_gradient {
    ColorStop { Color(8, 14, 24, 240), 0.0f },
    ColorStop { Color(12, 22, 38, 240), 0.45f },
    ColorStop { Color(18, 32, 54, 240), 0.50f },
    ColorStop { Color(10, 18, 30, 240), 0.55f },
    ColorStop { Color(6, 10, 18, 240), 1.0f }
};

static constexpr struct {
    Color base { 10, 20, 34, 230 };
    Color border { 0, 229, 255, 240 };
} s_frame_colors;
